...
def step_impl(context):
    context.register_page.enter_first_name("Ranjan")
    context.register_page.enter_last_name("Lamichhane")
    new_email = EmailWithTimeStampGenerator.get_new_email_with_timestamp()
    context.register_page.enter_email(new_email)
    context.register_page.enter_telephone("9823940823")
    context.register_page.enter_password("password1")
    context.register_page.enter_password_confirm("password1")
...
def step_impl(context):
    context.register_page.enter_email("lamichhaneranjan11@gmail.com")
...
def step_impl(context):
    assert context.register_page.display_status_of_all_warning_message("Warning: You must agree to the Privacy Policy!",

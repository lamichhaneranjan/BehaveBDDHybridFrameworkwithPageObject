...
class RegisterPage(BasePage):
    ...
    def enter_email(self, email_text):
        self.type_into_element("email_address_id", self.email_field_id, email_text)
    ...
    def enter_password(self, password_text):
        self.type_into_element("password_id", self.password_field_id, password_text)
    ...
    def display_status_of_all_warning_message(self, expected_privacy_warning, expected_first_name_warning,
                                              expected_last_name_warning, expected_email_warning,
                                              expected_telephone_warning, expected_password_warning):
        privacy_status = self.retrieved_element_text_equals("privacy_policy_warning_xpath", self.privacy_policy_warning_xpath, expected_privacy_warning)
        first_name_status = self.retrieved_element_text_equals("first_name_warning_xpath",
                                                               self.first_name_warning_xpath,
        ...
        email_status = self.retrieved_element_text_equals("email_warning_xpath", self.email_address_warning_xpath,
